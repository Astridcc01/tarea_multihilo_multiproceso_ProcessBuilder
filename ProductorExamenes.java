...
public class ProductorExamenes implements Runnable {
    ...
    public ProductorExamenes(BufferExamenes buffer) {
        ...
        numeroExamen+=1;
        // Construye el hilo. El nombre será la letra E seguida del valor 
        // de la variable numeroExamen.
    ...
    public void run() {
        ...
        // Muestra un mensaje en consola informando sobre el código del 
        // examen que se acaba de producir.
        System.out.println("El código del examen es "+codigo);
    }
} 
