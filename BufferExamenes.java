...
public class BufferExamenes {
    ...
    public synchronized void fabricarNuevoExamen(String codigo) {
        ...
        // Un hilo de la clase ProductorExamenes se encargará de fabricarlo 
        //y pasarlo como argumento a este método.
        colaExamenes.add(codigo);
        notify();
        // Añade el código pasado como argumento a la cola y libera el hilo que 
        //está intentando consumir un nuevo examen.
    }
